 ...
 * @return {String}
 */
Handsontable.helper.stringify2 = function (value) {
  switch (typeof value) {
    case 'string':
    case 'number':
...
Handsontable.CheckboxRenderer = function (instance, TD, row, col, prop, value, cellProperties) {
  ...
  if (value === cellProperties.checkedTemplate || Handsontable.helper.stringify2(value) === Handsontable.helper.stringify2(cellProperties.checkedTemplate)) {
    INPUT.checked = true;
    TD.appendChild(INPUT);
  }
  else if (value === cellProperties.uncheckedTemplate || Handsontable.helper.stringify2(value) === Handsontable.helper.stringify2(cellProperties.uncheckedTemplate)) {
    TD.appendChild(INPUT);
  }
